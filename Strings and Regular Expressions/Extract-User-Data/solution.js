function solve() {
    ...
    inputArr.forEach(element => {
        ...
        if (match) {
            ...
            // let validUserName = paragraphElemet.cloneNode();
            // validUserName.textContent = `Name: ${match[1]}`;
            // resultElement.appendChild(validUserName);
            //
            // let validENumber = paragraphElemet.cloneNode();
            // validENumber.textContent = `Phone Number: ${match[2]}`;
            // resultElement.appendChild(validENumber);
            //
            // let validEmail = paragraphElemet.cloneNode();
            // validEmail.textContent = `Email: ${match[3]}`;
            // resultElement.appendChild(validEmail);
